    ...
    <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-xl sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          <NavLink
            to="/"
            className="flex items-center font-bold text-green-700 dark:text-green-400 text-2xl tracking-tight whitespace-nowrap"
          >
        ...
        {/* Desktop Auth - User or Guest */}
        <div className="hidden md:flex items-center gap-4 relative">
          {!user ? (
            <>
              <NavLink to="/users/login" className={navLinkClass}>
                Login
              </NavLink>
              <NavLink
                to="/users/register"
                className={({ isActive }) =>
                  `ml-1 transition rounded px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium shadow ${
