    ...
    <div className="">
      ...
      <section className="pt-12 pb-8 px-4 text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
          {/* Plan Route Button */}
          <button
            onClick={scrollToRoutePlanner} // Scroll to Route Planner section
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded shadow font-medium flex items-center justify-center gap-2 text-base mx-auto sm:mx-0 transform transition-transform duration-400 hover:scale-107"
          >
          ...
          <button
            onClick={() => navigate('/routes')} // Navigate to Routes page
            className="border border-gray-200 hover:border-green-600 text-green-700 bg-white px-6 py-3 rounded shadow font-medium flex items-center justify-center gap-2 text-base mx-auto sm:mx-0 transform transition-transform duration-400 hover:scale-107"
          >
      ...
      <div className="py-5 flex flex-col items-center gap-5">
        ...
        <div className="flex justify-center gap-5">
          ...
          <div className="bg-white rounded-md shadow-md w-80 overflow-hidden mx-auto sm:mx-0 transform transition-transform duration-400 hover:scale-107">
            ...
            New Haven → Akanu Ibiam Airport
            </div>
            <div className="p-4 text-sm text-gray-600">
            Connects New Haven area to Akanu Ibiam International Airport via Independence Layout.
            </div>
            <div className="p-4 flex justify-between items-center">
